export default function build(client) {
    ...
    function requireLogin(init = true) {
        form.hidden = false;
        throber.hidden = true;
        error.hidden = true;
    ...
    function finishLoading() { loading.close() }
    function labelLoadingStage(label) { loadingLabel.innerText = label; }
